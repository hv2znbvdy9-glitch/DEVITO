...
from ava.wellbeing.orchestrator import WellbeingOrchestrator, WellbeingScore
...
async def unlock_happiness(request: AchievementRequest) -> Dict[str, Any]:
    ...
    await wellbeing.happiness.track_achievement("default_user", request.title, request.reward_points)
