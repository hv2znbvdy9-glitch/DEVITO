...
from ava.security import threat_log, rate_limiter, SECURITY_HEADERS, ThreatLevel
...
class SecurityMiddleware(BaseHTTPMiddleware):
    ...
    async def dispatch(self, request: Request, call_next):
        ...
        logger.info(
            f"📝 {request.method} {endpoint} - {client_ip} - Status: {response.status_code}"
        )
...
class AuditLogger:
    ...
    def log_action(self, user: str, action: str, resource: str, status: str, details: dict = None):
...
__all__ = ["SecurityMiddleware", "apply_security_middleware", "audit_logger", "AuditLogger"]
